  ...
  const handleOptionSelect = useCallback(
    (option, isCorrect) => {
      if (!isAnswered) {
        ...
        setCardBackgroundColor(isCorrect ? 'bg-green-300' : 'bg-red-300');
  ...
  return (
    ...
    >
      ...
      <div className='grid grid-cols-12 items-center gap-4'>
        <div className='col-span-10 relative w-full bg-gray-200 rounded-lg h-1'>
          <div
            className='absolute top-0 left-0 bg-blue-500 rounded-lg h-4 progress-bar'
